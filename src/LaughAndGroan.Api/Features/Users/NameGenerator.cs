// Copied from Moby Docker Container Name Generator 9/8/2020
// Apache 2.0 License
...
namespace LaughAndGroan.Api.Features.Users
{
    ...
    public static class NameGenerator
    {
        ...
        public static string GetRandomName(int retry = 0)
        {
            var left = _left[RandomNumberGenerator.GetInt32(_left.Length)];
            var right = _right[RandomNumberGenerator.GetInt32(_left.Length)];
            var retryString = retry > 0 ? $"_{RandomNumberGenerator.GetInt32(retry)}" : "";

            return $"{left}_{right}{retryString}";
        }
    }
}
