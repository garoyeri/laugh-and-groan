...
export class Lambdas extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, tables: dynamodb.Table[]) {
    super(scope, id);

    this.postAuthTrigger = new lambda.Function(this, "UserPoolPostAuthenticationTrigger", {
    ...
    this.createPostLambda = new lambda.Function(this, "CreatePostFunction", {
      runtime: lambda.Runtime.DOTNET_CORE_3_1,
      code: lambda.Code.fromAsset("resource/LaughAndGroan.zip"),
      handler: "LaughAndGroan.Actions::LaughAndGroan.Actions.Posts.PostsHandler::Create",
      logRetention: 30,
    });
    ...
    this.getPostLambda = new lambda.Function(this, "GetPostFunction", {
      runtime: lambda.Runtime.DOTNET_CORE_3_1,
      code: lambda.Code.fromAsset("resource/LaughAndGroan.zip"),
      handler: "LaughAndGroan.Actions::LaughAndGroan.Actions.Posts.PostsHandler::Get",
      logRetention: 30,
    });
    ...
    this.getPostsLambda = new lambda.Function(this, "GetPostsFunction", {
      runtime: lambda.Runtime.DOTNET_CORE_3_1,
      code: lambda.Code.fromAsset("resource/LaughAndGroan.zip"),
      handler: "LaughAndGroan.Actions::LaughAndGroan.Actions.Posts.PostsHandler::GetPosts",
      logRetention: 30,
    });
    ...
    this.deletePostLambda = new lambda.Function(this, "DeletePostFunction", {
      runtime: lambda.Runtime.DOTNET_CORE_3_1,
      code: lambda.Code.fromAsset("resource/LaughAndGroan.zip"),
      handler: "LaughAndGroan.Actions::LaughAndGroan.Actions.Posts.PostsHandler::Delete",
      logRetention: 30,
    });

    // give every lambda permission to use the dynamo tables
    [this.postAuthTrigger, this.deletePostLambda, this.getPostLambda, this.getPostsLambda, this.createPostLambda].forEach(l => {
      tables.forEach(t => {
